...
It is 1926, and Lester Germer has a problem he has not yet recognized as a discovery. For months he and Clinton Davisson had been firing electrons at a nickel surface and logging where they scattered. The data were dispiritingly dull: a smooth, featureless smear of electrons bouncing off at every angle, just what you would expect from billiard balls striking a rough wall. Then a flask of liquid air burst near the apparatus. The vacuum tube cracked. Oxygen rushed in, oxidized the nickel, and wrecked weeks of work. To salvage the target they annealed it — heating it slowly until the oxide cooked away. When they resumed, the smooth smear was gone. In its place stood sharp peaks at particular angles.

Without intending to, they had turned polycrystalline nickel into a single crystal. A single crystal has regular atomic planes — the same orderly planes that William Lawrence Bragg had shown would diffract X-rays. The electrons, it emerged, were behaving exactly as X-rays behave when they scatter from a crystal lattice. Not because Davisson and Germer had designed the experiment that way. Because physics left them no choice.

Two years earlier, a doctoral student in Paris had predicted something of the sort. Louis-Victor de Broglie argued, in a thesis his committee very nearly rejected, that if light waves can act like particles — which Einstein had shown in 1905, through the photoelectric effect — then matter particles ought to act like waves. The symmetry was clean. Einstein had shown that electromagnetic waves carry momentum $p = h/\lambda$, where $h$ is Planck's constant. De Broglie simply ran the relation in reverse: a particle of momentum $p$ should carry an associated wavelength

$$\lambda = \frac{h}{p}.$$

The committee consulted Einstein before approving the thesis. Einstein called the idea brilliant. De Broglie received the Nobel Prize in 1929 — the only one ever awarded specifically for a doctoral thesis. The Davisson–Germer accident, read in that light, was the confirmation. And the confirmation raised a question that proved harder than the formula: what, exactly, is doing the waving?
...
Begin with what de Broglie actually wrote. For a non-relativistic particle with kinetic energy $K$ and mass $m$, momentum and energy are tied together by $K = p^2/2m$, so $p = \sqrt{2mK}$. Substituting:
...
For electrons specifically — a quantity you will compute over and over — the numbers collapse into a handy shortcut:

$$\lambda_{\text{electron}} \approx \frac{1.226\text{ nm}}{\sqrt{V\text{ (in volts)}}}.$$

At 150 volts, $\lambda \approx 0.1$ nm. One tenth of a nanometer. One ångström. This is no accident — it is roughly the spacing between atoms in a solid. For a wave to diffract from a crystal, its wavelength must be comparable to the crystal's spacing. X-rays manage this because their wavelengths fall in the ångström range. The de Broglie formula says that electrons accelerated through a few hundred volts land in the very same range. That is why Davisson and Germer could see diffraction at all, and why Bragg's law — built entirely for X-rays — carried over to electrons without a single change.

And here is what the wavelength is not: it is not the physical size of the electron. The classical electron radius is roughly $2.8 \times 10^{-15}$ m — eight orders of magnitude smaller than the 0.167 nm de Broglie wavelength of a 54 eV electron. The wavelength is a property of the electron's state of motion, not of its physical extent. The distinction matters enormously when students first meet the idea, because the intuitive picture — some little ball with ripples around it — is simply wrong. The wave and the particle are not separable parts of one object. The wave *is* the thing, in the sense that it is the only object that evolves deterministically between observations.
...
De Broglie's idea was not pulled from thin air. The argument has a logical structure worth tracing. Einstein's special relativity demanded that energy and momentum transform together as a four-vector. De Broglie noticed that frequency and wave vector (the spatial frequency $1/\lambda$) likewise transform as a four-vector. For a photon, the relation $E = h\nu$ ties these two four-vectors together by the single constant $h$. De Broglie asserted that the same constant ties them together for any particle. It was a symmetry argument, not an empirical fit. The experiments arrived afterward.

---

## The Davisson–Germer Experiment

Rebuild the 1927 result from first principles and you see precisely why it convinces.
...
Translating the Bragg angle into the scattering angle measured from the forward beam in the Davisson–Germer geometry gives roughly 47° — close to the observed 50°. The small residual gap is not a failure of de Broglie. It comes from the fact that electrons entering a metal crystal feel an attractive inner potential, which speeds them up a little and shortens their wavelength inside the crystal. Correct for that inner potential and the prediction lands in exact agreement.

This is the shape of a successful quantitative test: a parameter-free prediction built from quantities measured entirely independently ($h$, $m_e$, $d$), set against an angle measured in an unrelated experiment that was not even designed to test the prediction. The agreement is not approximate. It becomes exact once the physics is accounted for in full.

Davisson and Germer did not fully grasp what they had until Davisson traveled to Europe and talked with Max Born, James Franck, and others who had been digesting de Broglie's and Schrödinger's new wave mechanics. George Paget Thomson, working independently in Aberdeen, was doing the kindred experiment — firing electrons through thin metal films and observing rings, the Debye–Scherrer geometry familiar from polycrystalline X-ray diffraction. Thomson and Davisson shared the 1937 Nobel Prize. (Davisson–Germer, *Physical Review* **30**, 705–740 (1927). doi:10.1103/PhysRev.30.705)
...
One point of logic deserves to be spelled out. The Davisson–Germer experiment does not prove that electrons *are* waves in any classical sense — extended oscillations in a medium, the way sound is. What it proves is that electrons produce interference and diffraction phenomena that can only be computed using wave mechanics. The distinction matters, because the very electron that produces a diffraction peak still arrives at the detector as a localized event — one click, one dot.

---

## Single Electrons, One at a Time

The hardest version of the experiment — and for that reason the most instructive — is the one Akira Tonomura and colleagues performed at Hitachi in 1989. They built a double-slit setup around an electron biprism: a fine wire held at positive potential that splits an electron beam into two coherent paths, physically equivalent to two slits. Then they dimmed the beam until fewer than one electron occupied the apparatus at any moment. Each electron struck a position-sensitive detector and was logged as a single localized dot.
...
The electrons did not interfere with one another. There was only ever one in the apparatus. Each arrived as a particle — a point — and laid down one dot in the pattern. Yet the distribution of those dots, accumulated over time, carries the mathematical structure of wave interference. The conclusion is not optional: each individual electron's wave function passed through both arms of the apparatus at once and interfered with itself. The dot on the detector marks where the wave function collapsed upon measurement. The interference pattern is the accumulated probability, and that probability was set by a wave that explored the full geometry on every single pass.

Tonomura's 1989 paper is the most famous demonstration of its kind, but the first single-electron buildup was shown by Pier Giorgio Merli, Giulio Missiroli, and Gianfranco Pozzi in Bologna in 1974 (published 1976 in the *American Journal of Physics*). Their experiment was voted one of the most beautiful in physics in a 2002 *Physics World* poll. The first experiment to use physically nano-fabricated real double slits — actual slits cut into a membrane, not a biprism — was Bach et al. in 2013. (Tonomura et al., *Am. J. Phys.* **57**, 117–120 (1989). doi:10.1119/1.16104; Bach et al., *New J. Phys.* **15**, 033018 (2013). doi:10.1088/1367-2630/15/3/033018)
...
Here is what the experiment rules out, and this is the part students most need to hear slowly. It rules out any model in which the electron follows a definite trajectory through one slit or the other. If electrons did follow definite trajectories, slowing the rate to one at a time would change nothing — you would get two bright regions behind the two slits and nothing in between. You do not get that. You get fringes reaching well into the geometric shadow. The pattern depends on the separation of both slits, even though each electron is only ever detected at a single place.

There is a tempting escape: perhaps the electron really does pass through one slit, but the act of not detecting it at the other somehow disturbs the outcome. This is not a live option. You can make the slits arbitrarily wide and the detector arbitrarily gentle, and the interference survives as long as you acquire no information about which slit the electron used. What destroys interference is not physical disturbance — it is information.

---

## Why Human-Scale Objects Don't Diffract

The de Broglie relation applies to everything. Not just electrons. Not just quantum particles. Everything with momentum carries an associated wavelength. The only question is whether that wavelength is large enough to matter.

A proton accelerated through the same 54 V has 1836 times the electron's mass. At equal kinetic energy its momentum is $\sqrt{1836}$ times larger, so its wavelength is $\sqrt{1836} \approx 43$ times smaller: about 4 pm. Still within reach of crystal diffraction — neutron and proton diffraction are real techniques in materials science.

A $\text{C}_{60}$ buckyball — sixty carbon atoms, mass roughly 720 atomic mass units — was diffracted from a grating with 50 nm slits by Anton Zeilinger's group in Vienna in 1999. At the effusion temperature of 900 K the de Broglie wavelength works out to about 2.5 pm (picometers) — smaller than the molecule itself. Yet the fringes appeared. The 2019 experiments by Fein and colleagues pushed this to molecules of roughly 2,000 atoms. (Arndt et al., *Nature* **401**, 680–682 (1999). doi:10.1038/44348; Fein et al., *Nat. Phys.* **15**, 1242–1245 (2019). doi:10.1038/s41567-019-0663-9)

Now compute the wavelength of a 70 kg person walking at 1 m/s:

$$\lambda = \frac{6.626 \times 10^{-34}}{70 \times 1} \approx 10^{-35}\text{ m.}$$

This is roughly twenty orders of magnitude smaller than a proton. No physical slit, no crystal lattice, no instrument of any kind could resolve a wavelength this small. Quantum interference is not absent for large objects — it is present and utterly invisible. Quantum mechanics does not break down at human scales. It becomes indistinguishable from classical mechanics because the wavelengths are so small that no physically buildable grating or aperture could ever reveal the fringe structure.

This is Bohr's correspondence principle made concrete: quantum mechanics contains classical mechanics as a limiting case, whenever the action of the system runs far larger than $\hbar$. The de Broglie wavelength makes that limit quantitative and immediate. You need no philosophical argument. You need only compute $h/p$.
