...
![Four-panel reference for the LLM prompt structure used in every chapter's exercise. Show: paste the artifact. Say: one-sentence imperative. Constrain: rules that shrink the search space. Verify: limit-behavior checkli...](../images/00-how-to-use-the-simulations-fig-01.png)
*Figure 0.1 — Four-Move Prompt*

![Systems diagram of three context files feeding a central LLM prompt. CLAUDE.md is the coding constitution (behavior). DESIGN.md is the visual constitution (appearance). PROJECT.md is the project state (memory). Three...](../images/00-how-to-use-the-simulations-fig-02.png)
*Figure 0.2 — Three-File System*

![Two Gaussian probability densities |ψ(x,t)|² on the same axes. At t=0: tall, narrow Gaussian at x=0, width about 0.7 nm. At t=15 fs: shorter, wider Gaussian at x=17 nm (drifted by group velocity), width about 1.4 nm....](../images/00-how-to-use-the-simulations-fig-03.png)
*Figure 0.3 — Gaussian Wave Packet Spreads*

![Two snapshots of Re(psi) for a Gaussian wave packet at two times. Orange crests inside the blue envelope. Between the snapshots, the envelope centroid moves twice as far as a representative crest. v_g equals h-bar k_0...](../images/00-how-to-use-the-simulations-fig-04.png)
*Figure 0.4 — Group Velocity Is Twice the Phase Velocity*
