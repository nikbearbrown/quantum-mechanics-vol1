...
- This chapter gives a working overview of The Time-Independent Schrödinger Equation, focusing on the ideas a reader needs before moving to the next chapter.
- The chapter moves through Separating the problem, The TISE, written out, The infinite square well — eight steps, What the ground state tells us about zero, and related ideas.
...
![The separation trick converts a PDE into two ODEs. The time part is solved by inspection; the spatial part is the eigenvalue problem that determines the allowed energies](../images/02-the-time-independent-schrodinger-equation-fig-01.png)
*Figure 2.1 — Separation-of-variables split diagram *
...
![Quantization is not assumed. It is what happens when you ask a sine wave to vanish at both walls simultaneously](../images/02-the-time-independent-schrodinger-equation-fig-02.png)
*Figure 2.2 — Diagram illustrating the collapse from continuous to discrete*
...
![The n-th eigenstate fits exactly n half-wavelengths between the walls. Nodes count the number of half-wavelengths minus one](../images/02-the-time-independent-schrodinger-equation-fig-03.png)
*Figure 2.3 — Energy-level diagram in the style of Griffiths Fig*
...
![The ground state (n=1) comes closest to saturating the uncertainty bound. Higher eigenstates have more nodes, wider momentum distributions, and larger σ_x σ_p](../images/02-the-time-independent-schrodinger-equation-fig-04.png)
*Figure 2.4 — Scatter plot or bar chart comparing σ_x ·*
...
| mass (kg) | L (m) | E_1 (eV) | E_2−E_1 (eV) | verdict (quantum |
| --- | --- | --- | --- | --- |
| electron in 1 nm well, electron in 1 cm box, proton in 1 nm well, C60 molecule in 10 nm trap, marble in 1 cm box | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| columns: mass (kg | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| L (m | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| E_1 (eV | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| E_2−E_1 (eV | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| verdict (quantum | borderline | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| student should see that E_1 ∝ 1 | (mL²) and identify which rows fall above and below thermal energy k_BT ≈ 0.025 eV at room temperature | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
...
![Position expectation oscillates at the beat frequency; energy expectation is exactly constant. The sloshing carries no energy — it is a phase phenomenon](../images/02-the-time-independent-schrodinger-equation-fig-05.png)
