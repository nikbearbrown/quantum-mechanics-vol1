...
- The chapter moves through What are we even looking at?, Why is $\psi$ complex at all?, The most persistent misconception, Normalization, and a calculation worth doing in full, and related ideas.
...
![Comparison of a population density map (people/km²) and](../images/01-the-wave-function-fig-01.png)
*Figure 1.1 — Comparison of a population density map (people/km²) and*
...
![Diagram of |ψ(x)|² curve with a shaded region](../images/01-the-wave-function-fig-02.png)
*Figure 1.2 — Diagram of |ψ(x)|² curve with a shaded region*
...
![Time sequence showing a Gaussian wave packet at](../images/01-the-wave-function-fig-03.png)
*Figure 1.3 — Time sequence showing a Gaussian wave packet at*
...
![ψ describes the histogram, not the dot.](../images/01-the-wave-function-fig-04.png)
*Figure 1.4 — Two-column diagram*
...
![Pipe-flow analogy for the continuity equation ∂ρ/∂t +](../images/01-the-wave-function-fig-05.png)
*Figure 1.5 — Pipe-flow analogy for the continuity equation ∂ρ/∂t +*
...
![narrow in x ↔ broad in p. You cannot localize both simultaneously.](../images/01-the-wave-function-fig-06.png)
*Figure 1.6 — Fourier duality diagram *
...
![No particle is measured twice. No disturbance occurs. The inequality is about the shape of ψ.](../images/01-the-wave-function-fig-07.png)
*Figure 1.7 — Two-group experimental protocol diagram *
...
![Plot](../images/01-the-wave-function-fig-08.png)
*Figure 1.8 — Plot*
