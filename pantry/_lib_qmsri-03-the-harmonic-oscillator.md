...
- The chapter moves through The trick, Climbing the ladder, Why the ladder terminates downward, The whole spectrum, and related ideas.
...
![Grid of six physical systems ](../images/03-the-harmonic-oscillator-fig-01.png)
*Figure 3.1 — Grid of six physical systems *
...
![Vertical energy ladder with evenly spaced rungs labeled](../images/03-the-harmonic-oscillator-fig-02.png)
*Figure 3.2 — Vertical energy ladder with evenly spaced rungs labeled*
...
![Schematic infrared absorption spectrum of HCl ](../images/03-the-harmonic-oscillator-fig-03.png)
*Figure 3.3 — Schematic infrared absorption spectrum of HCl *
...
![Six stacked panels showing ψ_n(x) for n =](../images/03-the-harmonic-oscillator-fig-04.png)
*Figure 3.4 — Six stacked panels showing ψ_n(x) for n =*
...
![The correspondence principle: at large n, quantum averages to classical](../images/03-the-harmonic-oscillator-fig-05.png)
*Figure 3.5 — Comparison of |ψ_n(x)|² for n = 1 and*
...
![Σ_x · σ_p / (ℏ/2) plotted vs](../images/03-the-harmonic-oscillator-fig-06.png)
*Figure 3.6 — Σ_x · σ_p / (ℏ/2) plotted vs*
...
![Three-frame time sequence showing |Ψ(x,t)|² for the equal](../images/03-the-harmonic-oscillator-fig-07.png)
*Figure 3.7 — Three-frame time sequence showing |Ψ(x,t)|² for the equal*
...
![Phase-space diagram showing the coherent state orbit ](../images/03-the-harmonic-oscillator-fig-08.png)
*Figure 3.8 — Phase-space diagram showing the coherent state orbit *
