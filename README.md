# Quantum Mechanics: Foundations: The Quantum World
...
- `images/quantum-mechanics-vol1-fig-NN.svg` — static SVG (→ PNG for EPUB)
- `d3/quantum-mechanics-vol1-fig-NN.html` — interactive D3 HTML
